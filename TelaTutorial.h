...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label22->Text = L"Cada emoji tem uma função dentro do código, como mostrado ao lado";
			// 
			// label23
			// 
			...
			this->label23->Text = L"É só arrastar o emoji, para a lacuna correta e clicar em compilar.";
			// 
			// label24
			// 
			...
			this->label25->Text = L"Funções e atribuições";
			// 
			// label26
			// 
			...
			this->label26->Text = L"Desvio e repetições";
			// 
			// label27
			// 
			...
			this->label27->Text = L"Entrada e saída";
			// 
			// TelaTutorial
			// 
